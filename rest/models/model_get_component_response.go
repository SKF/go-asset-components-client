...
func (o *GetComponentResponse) GetFixedSpeed() float32 {
...
// and a boolean to check if the value has been set.
func (o *GetComponentResponse) GetFixedSpeedOk() (*float32, bool) {
	if o == nil || o.FixedSpeed == nil {
		return nil, false
	}
...
func (o *GetComponentResponse) SetFixedSpeed(v float32) {
	o.FixedSpeed = &v
}
