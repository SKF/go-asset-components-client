...
func NewCreateComponentRequest(asset string, type_ string, position int32) *CreateComponentRequest {
...
func (o *CreateComponentRequest) GetId() string {
	if o == nil || o.Id == nil {
		var ret string
		return ret
	}
...
func (o *CreateComponentRequest) GetIdOk() (*string, bool) {
	if o == nil || o.Id == nil {
		return nil, false
	}
	return o.Id, true
...
func (o *CreateComponentRequest) HasId() bool {
	if o != nil && o.Id != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetId(v string) {
	o.Id = &v
}

// GetAsset returns the Asset field value
func (o *CreateComponentRequest) GetAsset() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetAssetOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Asset, true
...
func (o *CreateComponentRequest) SetAsset(v string) {
	o.Asset = v
}

// GetAttachedTo returns the AttachedTo field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetAttachedTo() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetAttachedToOk() (*string, bool) {
	if o == nil || o.AttachedTo == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasAttachedTo() bool {
	if o != nil && o.AttachedTo != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetAttachedTo(v string) {
	o.AttachedTo = &v
}

// GetType returns the Type field value
func (o *CreateComponentRequest) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *CreateComponentRequest) SetType(v string) {
	o.Type = v
}

// GetPosition returns the Position field value
func (o *CreateComponentRequest) GetPosition() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetPositionOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) SetPosition(v int32) {
	o.Position = v
}

// GetOrigin returns the Origin field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetOrigin() Origin {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetOriginOk() (*Origin, bool) {
	if o == nil || o.Origin == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasOrigin() bool {
	if o != nil && o.Origin != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetOrigin(v Origin) {
	o.Origin = &v
}

// GetFixedSpeed returns the FixedSpeed field value if set, zero value otherwise.
// Deprecated
func (o *CreateComponentRequest) GetFixedSpeed() float64 {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *CreateComponentRequest) GetFixedSpeedOk() (*float64, bool) {
	if o == nil || o.FixedSpeed == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasFixedSpeed() bool {
	if o != nil && o.FixedSpeed != nil {
		return true
	}
...
// Deprecated
func (o *CreateComponentRequest) SetFixedSpeed(v float64) {
	o.FixedSpeed = &v
}

// GetPositionDescription returns the PositionDescription field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetPositionDescription() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetPositionDescriptionOk() (*string, bool) {
	if o == nil || o.PositionDescription == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasPositionDescription() bool {
	if o != nil && o.PositionDescription != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetPositionDescription(v string) {
	o.PositionDescription = &v
}

// GetDesignation returns the Designation field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetDesignation() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetDesignationOk() (*string, bool) {
	if o == nil || o.Designation == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasDesignation() bool {
	if o != nil && o.Designation != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetDesignation(v string) {
	o.Designation = &v
}

// GetManufacturer returns the Manufacturer field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetManufacturer() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetManufacturerOk() (*string, bool) {
	if o == nil || o.Manufacturer == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasManufacturer() bool {
	if o != nil && o.Manufacturer != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetManufacturer(v string) {
	o.Manufacturer = &v
}

// GetSerialNumber returns the SerialNumber field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetSerialNumber() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetSerialNumberOk() (*string, bool) {
	if o == nil || o.SerialNumber == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasSerialNumber() bool {
	if o != nil && o.SerialNumber != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetSerialNumber(v string) {
	o.SerialNumber = &v
}

// GetRotatingRing returns the RotatingRing field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetRotatingRing() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetRotatingRingOk() (*string, bool) {
	if o == nil || o.RotatingRing == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasRotatingRing() bool {
	if o != nil && o.RotatingRing != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetRotatingRing(v string) {
	o.RotatingRing = &v
}

// GetShaftSide returns the ShaftSide field value if set, zero value otherwise.
func (o *CreateComponentRequest) GetShaftSide() string {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetShaftSideOk() (*string, bool) {
	if o == nil || o.ShaftSide == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) HasShaftSide() bool {
	if o != nil && o.ShaftSide != nil {
		return true
	}
...
func (o *CreateComponentRequest) SetShaftSide(v string) {
	o.ShaftSide = &v
}
