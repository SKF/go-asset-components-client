...
func (o *CreateComponentRequest) GetFixedSpeed() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateComponentRequest) GetFixedSpeedOk() (*float32, bool) {
	if o == nil || o.FixedSpeed == nil {
		return nil, false
	}
...
func (o *CreateComponentRequest) SetFixedSpeed(v float32) {
	o.FixedSpeed = &v
}
