...
func (o *UpdateComponentResponse) GetFixedSpeed() float32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateComponentResponse) GetFixedSpeedOk() (*float32, bool) {
	if o == nil || o.FixedSpeed == nil {
		return nil, false
	}
...
func (o *UpdateComponentResponse) SetFixedSpeed(v float32) {
	o.FixedSpeed = &v
}
