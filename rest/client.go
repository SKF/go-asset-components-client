...
type Client interface {
	GetComponent(context.Context, uuid.UUID) (models.GetComponentResponse, error)
...
func (c *client) GetComponent(ctx context.Context, id uuid.UUID) (models.GetComponentResponse, error) {
	request := rest.Get("components/{component}").
		Assign("component", id).
		SetHeader("Accept", "application/json")

	var response models.GetComponentResponse
	if err := c.DoAndUnmarshal(ctx, request, &response); err != nil {
		return models.GetComponentResponse{}, err
	}
